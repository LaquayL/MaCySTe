...
autopilot_pod_autopilot_extra_var_autopilot_nmea_tcp_host = $(autopilot_pod_autopilot_eth0_ip)
autopilot_pod_autopilot_extra_var_autopilot_nmea_tcp_port = $(autopilot_nmea_tcp_port)
