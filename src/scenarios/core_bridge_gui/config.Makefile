...
MODULES += sgs_hmi sgs_master # SGS simulator
MODULES += ecdis_opencpn # ECDIS (OpenCPN)
MODULES += gui_home gui_instruments # GUI for MaCySTe (leave it near the end if you are leveraging the dynamic GUI functionality)